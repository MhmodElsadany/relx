...
public class CategoryVM extends ViewModel {
    ...
    Context mContext;
    private MutableLiveData<ArrayList<CateogryModel>> mproductMutableLiveData;
    CompositeDisposable compositeDisposable = new CompositeDisposable();
    ProgressBar pb;
    AlertDialog.Builder builder;

    public LiveData<ArrayList<CateogryModel>> getResult(Context mContext, ProgressBar pb, AlertDialog.Builder builder) {
        this.mContext = mContext;
        this.pb = pb;
        this.builder = builder;
        if (mproductMutableLiveData == null) {
            mproductMutableLiveData = new MutableLiveData<ArrayList<CateogryModel>>();
            loadData();
    ...
    private void loadData() {
        ...
        compositeDisposable.add(api.getCategory()
                ...
                .subscribe(new Consumer<ArrayList<CateogryModel>>() {

                    @Override
                    public void accept(ArrayList<CateogryModel> cateogryModels) throws Exception {
